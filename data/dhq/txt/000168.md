...
[^6]:  We are also grateful for advice provided by the
                        ...
                        National University (http://ncb.anu.edu.au/scanner). 
[^7]: 
...
[^9]: The dictionary was compiled from Kevin
                            Atkinson’s SCOWL wordlists (Spell Checker Oriented Wordlists)
...
[^11]: Frank Walworth was pardoned four years after his conviction,
                        but this twist to the story attracted little attention from the press . 
[^12]:  For information on the
                        ...
                        compiled for use in spell checkers. We are grateful for Loretta
                            Auville’s advice on this aspect of our study.
[^13]: 
...
[^14]:  Apparently by accident, this study uses an incorrect variant of the log
                        ...
                        order to use the log likelihood ratio as it originally appeared in . This confirms the need for humanities scholars
...
[^17]: Meandre (http://seasr.org/meandre), Monk
                            (http://monkproject.org) and
                        OpenNLP (http://opennlp.apache.org). These tools were sufficiently
                        powerful for our study, though there are a range of other similar tools
                        available, such as Wmatrix (http://ucrel.lancs.ac.uk/wmatrix/) and WordSmith (http://www.lexically.net/wordsmith/). 
