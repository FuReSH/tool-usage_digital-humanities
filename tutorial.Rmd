...
```{r}
f.wordcloud.frequency(df.dhconfs.abstracts.tools, 50, paste("tools in", nrow(df.dhconfs.abstracts.tools),  "abstracts from DH conferences"), "Data: Weingart et al., 'Index of Digital Humanities Conferences Data', https://doi.org/10.1184/R1/12987959.v4", "png")
```

![This is one of the saved visualisations](visualization/wordcloud-rel-100_tools%20in%20136%20abstracts%20from%20DH%20conferences-w_50.png)
