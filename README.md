...
- `data/`
    + `dh-conferences/`: 
        ...
        * `DHd/`: data on DHd conferences from Henny-Krahmer, Ulrike, and Daniel Jettka. *Softwarezitation in Den Digital Humanities*. Zenodo, 2021. <https://doi.org/10.5281/zenodo.5106391>.
